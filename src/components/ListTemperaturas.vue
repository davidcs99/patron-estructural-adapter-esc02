<template>
      <!-- <v-container v-if="!showForm"> -->
        <!-- <v-card class="mx-auto pa-6" max-width="auto" >
...
import axios from '@/plugins/axios';
  ...
  export default {
    ...
    methods: {
      ...
      async getData() {
        try {
            const grid= await axios.get(`/temperatura/obtenerTodasMediciones`);
            console.log(grid)
